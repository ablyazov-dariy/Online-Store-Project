// @ts-ignore
import styles from './checkoutStyles.css?inline'

export const checkoutHtmlTemplate: HTMLTemplateElement = document.createElement('template')
checkoutHtmlTemplate.innerHTML = `<div id="wrapper">
  <div class="row">
    <div class="col-xs-5">
      <div id="cards">
  ...
  <label class="form-check-label" for='card'>
    ...
    Pay $<span class="price-to-pay"></span> with credit card
  </label>
</div>
    </div><!--col-xs-5 end-->
    <div class="col-xs-5">
  ...
  <label class="form-check-label" for='paypal'>
    ...
    Pay $<span class="price-to-pay"></span> with PayPal
  </label>
</div>
    </div><!--col-xs-5 end-->
  </div><!--row end-->
